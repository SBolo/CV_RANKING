...
import sys
import argparse
import contacts.RPopulationHistogramClass as PoHC
...
def get_args():
    ...
    parser.add_argument(
    				'-w', '--weights', type = str,
    				help = 'Weights file', required = False, default = '')

    args = parser.parse_args()

    return args.q_dir, args.bins, args.out_dir, args.global_q, args.weights
#-----------------------------------------------------------------------------------------------------------------------
...
if __name__ == '__main__':
	...
	Q_dir, B, out_dir, global_q, weights = get_args()
	...
	ph = PoHC.PopulationHistogram(Q_dir, out_dir, B, global_q, weights)
